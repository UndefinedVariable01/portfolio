    ...
    return (
        <div className={`${sectionGapTop} ${sectionGapBottom} ${about}`} id="about">
            ...
            <div className={`${container} ${c3}`}>
                ...
                <p className={answer}>21 years old</p>
            </div>
            ...
            <div className={`${container} ${c5}`}>
                ...
                <p className={answer}>3 years(1.5 years web dev)</p>
            </div>
            ...
            <div className={`${container} ${c9}`}>
                ...
                <p className={answer}>You can use my email: uva@gmail.com or the contact form below</p>
            </div>
        </div>
    )
}
